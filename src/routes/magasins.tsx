...
export const Route = createFileRoute("/magasins")({
  head: () => ({
    meta: [
      ...
      { name: "description", content: "Retrouvez PC Leader à Jarry, Dothémare et Le Moule. Adresses, horaires et itinéraires." },
    ],
  }),
      ...
      <div className="mt-12 rounded-2xl border bg-secondary p-8 text-secondary-foreground">
        <div className="grid gap-4 md:grid-cols-[1fr,auto] md:items-center">
          <div>
            ...
            <p className="mt-2 text-secondary-foreground/70">Un seul numéro pour les 3 magasins. Ouvert du lundi au samedi.</p>
          </div>
          <div className="flex flex-wrap gap-3">
            <Button asChild size="lg"><a href="tel:0590326363"><Phone className="h-4 w-4" /> 05 90 32 63 63</a></Button>
            <Button asChild size="lg" variant="outline" className="border-secondary-foreground/30 text-secondary-foreground hover:bg-secondary-foreground/10">
              <a href="mailto:contact@pcleader.fr"><Mail className="h-4 w-4" /> contact@pcleader.fr</a>
            </Button>
          </div>
        </div>
      </div>
